...
@section('title', 'Iniciar Sesión - Turiscovery')
    ...
    <div class="container" style="max-width: 500px; margin-top: 4rem; margin-bottom: 4rem;">
        <div class="card" style="padding: 2rem;">
            ...
            <div style="text-align: center; margin: 1.5rem 0;">
                <p style="color: var(--text-secondary);">o continúa con</p>
            </div>
            ...
            <div style="text-align: center; margin-top: 2rem;">
                <p style="color: var(--text-secondary);">¿No tienes cuenta? <a href="/register"
                        style="color: var(--primary); font-weight: 600;">Regístrate</a></p>
            </div>
        </div>
    </div>
@endsection
        ...
        document.getElementById('login-form').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (error.response?.status === 422) {
                    ...
                    errorDiv.textContent = 'Demasiados intentos. Por favor, espera un momento.';
                } else {
